...
//go:generate minimock -i github.com/olezhek28/microservices_course/week_4/internal/repository.NoteRepository -o ./mocks/note_repository_minimock.go -n NoteRepositoryMock
